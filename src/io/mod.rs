...
impl<'a, B: IoBackend> Io<'a, B> {
    ...
    -> Result<Self, IoError<B::BackingError, B::RegionAddress>> 
    {
        ...
        backing.write_region_header(wal_address, 
            sequence, 
            collection_id, 
            collection_type, 
            wal_address,
        ...
        Ok(Self { backing, wal_address, wal_offset: 0 })
    }
    ...
    pub fn open(backing: &'a mut B) -> Result<Self, IoError<B::BackingError, B::RegionAddress>> {
        ...
        Ok(Self { backing, wal_address, wal_offset })
    }
}
...
pub trait IoBackend: Sized + Debug {
    ...
    type RegionHeader<'a>: RegionHeader<Self> where Self: 'a;
    ...
    fn write_region_header<'a>(&mut self, index: Self::RegionAddress, 
