...
- [x] **D18 — Relational safety invariants.** Agree the disjointness,
...
- [x] **D19 — Region-incarnation and stale-link validation.** Decide what
...
- [x] **D19A — Allocation-sequence propagation.** Define the free list's next
